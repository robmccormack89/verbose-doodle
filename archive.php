...
if ( is_day() ) {
	$context['title'] = esc_html__('Day:', 'verbose-doodle').' '.get_the_date( 'D M Y' );
} else if ( is_month() ) {
	$context['title'] = esc_html__('Month:', 'verbose-doodle').' '.get_the_date( 'M Y' );
} else if ( is_year() ) {
	$context['title'] = esc_html__('Year:', 'verbose-doodle').' '.get_the_date( 'Y' );
} else if ( is_tag() ) {
	$context['title'] = esc_html__('Tag:', 'verbose-doodle').' '.single_tag_title( '', false );
} else if ( is_category() ) {
	$context['title'] = esc_html__('Category:', 'verbose-doodle').' '.single_cat_title( '', false );
