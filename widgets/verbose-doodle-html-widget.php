<?php
/**
 * Widget API: Verbose_Doodle_Custom_UIKIT_Widget_Class class
 *
 */
 ...
 * @see WP_Widget
 */
class Verbose_Doodle_Custom_Widget_Class extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        parent::__construct('verbose_doodle_custom_html', __('Verbose Doodle Custom HTML'), $widget_ops, $control_ops);
    }
    ...
    public function _register_one($number = -1)
    {
        ...
        add_action('admin_footer-widgets.php', array( 'Verbose_Doodle_Custom_Widget_Class', 'render_control_template_scripts' ));

        // Note this action is used to ensure the help text is added to the end.
        add_action('admin_head-widgets.php', array( 'Verbose_Doodle_Custom_Widget_Class', 'add_help_text' ));
    }
    ...
    public function widget($args, $instance)
    {
         ...
         * @param Verbose_Doodle_Custom_Widget_Class $this     Current Custom HTML widget instance.
         */
     ...
     *
     * @since 4.8.1
     * @since 4.9.0 The form contains only hidden sync inputs. For the control UI, see `Verbose_Doodle_Custom_Widget_Class::render_control_template_scripts()`.
     *
     * @see Verbose_Doodle_Custom_Widget_Class::render_control_template_scripts()
